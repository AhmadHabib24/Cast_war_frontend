        ...
        <div className="min-h-screen bg-[var(--color-off-white)] flex flex-col justify-center py-12 px-6">
            ...
            <div className="max-w-md w-full mx-auto bg-white rounded-3xl p-10 shadow-xl border border-[var(--color-border-gray)]">
                ...
                <div className="text-center mb-10">
                    <h2 className="text-4xl font-black text-[var(--color-brand-black)] uppercase tracking-tight">Enter <span className="text-[var(--color-metallic-gold)]">The War</span></h2>
                    <p className="text-[var(--color-muted-text)] font-medium mt-2">Access your Headquarters</p>
                </div>
                ...
                <div className="mt-8 text-center text-sm font-bold text-[var(--color-muted-text)]">
                    Don't have an account? <Link href="/register" className="text-[var(--color-rich-gold)] hover:text-[var(--color-metallic-gold)] transition-colors">Join the War</Link>
                </div>
            </div>
        </div>
    );
